...
urlpatterns = [
    ...
    re_path('^create_resource/$', views.create_resource, name="create_resource"),
    re_path('^create_resource_api/$', views.create_resource_api, name="create_resource_api"),
    ...
    re_path('^rolemanagement/', include('rolemanagement.urls'))
]
